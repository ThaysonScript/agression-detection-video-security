...
# === CONFIGURAÇÕES ===
FRAMES_DIR = Path("/content/drive/MyDrive/frames_processados/anomaly_frames_pt_1/abuse/5_frame_per_second_extract_abuse_anomaly/Abuse001_x264")  # Ex: .../frames/
KEYPOINTS_DIR = Path("/content/drive/MyDrive/keypoints_frames_processados/anomaly_frames_pt_1/abuse/5_frame_per_second_extract_abuse_anomaly_keypoints/Abuse001_x264")  # Ex: .../keypoints/


MAX_FRAMES = 100  # Número de imagens a exibir
